...
{
    /// <summary>
    /// کلاس کمکی جهت تولید پسورد تصادفی
    /// </summary>
    public class PasswordGenerator
    {
        ...
        /// <summary>
        /// مجموعه کاراکتر هایی که در تولید پسورد نباید استفاده شوند
        /// </summary>
        ...
        /// <summary>
        /// لیست کاراکتر های استفاده شده در تولید پسورد
        /// </summary>
        private char[] pwdCharArray = "abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789`~!@#$%^&*()-_=+[]{}\\|;:'\",<.>/?".ToCharArray();
        
        /// <summary>
        /// لیست کاراکتر هایی که در تولید پسورد در مواردی که باید پسورد ایمیل یا پیامک شوند
        /// باید از تولید پسورد حذف شوند. معمولا پسورد از کاراکتر های ساده الفبایی و عددی تولید می شود
        /// </summary>
        public const string SimplePasswordExclusions = "`~!@#$%^&*()-_=+[]{}\\|;:'\",<.>/?";
    }
}
